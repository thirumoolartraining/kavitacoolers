      ...
      >
        <motion.div variants={item} className="mb-12">
          <p className="text-gray-700 mb-8">
            Welcome to Kavita Cooler Services. By accessing our website, booking a service, or engaging with our customer support team, you agree to the following Terms & Conditions. These terms govern all repair services, inquiries, and interactions with Kavita Cooler Services.
          </p>
        ...
        <motion.div variants={item} className="mb-12">
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <li>Kavita Cooler Services does not store your financial details; all transactions are processed securely by third-party payment providers.</li>
          </ul>
        </motion.div>
        ...
        <motion.div variants={item} className="mb-12">
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <li>Kavita Cooler Services is not responsible for failures caused by customer misuse, lack of maintenance, or previously unauthorized repairs.</li>
          </ul>
        </motion.div>
        ...
        <motion.div variants={item} className="mb-12">
          ...
          <p className="text-gray-700">
            All content on our website, including logos, service descriptions, and marketing materials, are the intellectual property of Kavita Cooler Services. Unauthorized reproduction or commercial use is strictly prohibited.
          </p>
        </motion.div>

        <motion.div variants={item} className="mb-12">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">8. Limitation of Liability</h2>
          <p className="text-gray-700 mb-4">Kavita Cooler Services shall not be liable for:</p>
        ...
        <motion.div variants={item} className="bg-gray-50 p-8 rounded-lg">
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="font-semibold text-gray-800">Kavita Cooler Services</h3>
                <p className="text-gray-700">
