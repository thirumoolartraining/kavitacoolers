      ...
      >
        <motion.div variants={item} className="mb-12">
          <p className="text-gray-700 mb-8">
            At Kavita Cooler Services, our primary focus is on providing quality repair and maintenance services. For customers who require spare parts, accessories, or replacement items, we ensure safe, reliable, and on-time delivery through trusted logistics partners.
          </p>
